...
C_FLAGS := -fpic -fsingle-precision-constant -mfloat-abi=hard
LD_FLAGS := -rdynamic -shared -fpic -lc -lm
endif


# ----------------------- LINUX armv7l (PengPod, BeagleBoard...) ---------------

ifeq ($(PLATFORM), Linux_armv7l)
DEFINEFLAGS := $(DEFINEFLAGS) -DUNIX 
EXTENSION := pd_linux
...
EXTENSION := pd_darwin
ARCHFLAGS := -arch ppc7400 -arch i386 -arch x86_64
